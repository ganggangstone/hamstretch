...
const T = {
  ko: {
    ...
    ctaTop: '데모 보기',
    ctaDemo: '데모 해보기',
    notOpen: '다운로드는 원티드 AI 챔피언십 심사 기간(~10/17) 동안 잠시 막아뒀어요. 그동안은 위 데모로 만나보세요 — 응원하고 싶으시면 <a href="https://event.wanted.co.kr/ai-championship/2026/projects/1723" target="_blank" rel="noopener">투표 한 번</a> 눌러주세요!',
  ...
  en: {
    ...
    notOpen: 'Downloads are on hold during the Wanted AI Championship judging period (through 10/17). Try the demo above in the meantime — a <a href="https://event.wanted.co.kr/ai-championship/2026/projects/1723" target="_blank" rel="noopener">vote</a> would help if you like it!',
